class Node:
  def __init__(self):	
    ...
    self.missing_attr_children = {} # a dictionary (key=probability of occuring that value among examples at the current node, value=node associated with that attribute value)
    ...
    self.is_pruning = False # flag to check if this node is getting pruned currently